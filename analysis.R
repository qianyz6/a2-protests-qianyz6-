...
# answer:
# 2017-01-20,"Gainesville, FL",500,Civil Rights (Woman's March),Civil Rights; For women's rights; Women's March,Yes,http://www.gainesville.com/news/20170121/about-1500-join-womens-march-in-gainesville,1
...
count_protests_in_location <- function(location) {
  if (location %in% locations) {
    num_protests_in_location <- length(locations[str_detect(locations, location)])
    paste0("There were ", num_protests_in_location, " protests in ", location, ".")
  } else {
...
print(table(high_level_purposes))
